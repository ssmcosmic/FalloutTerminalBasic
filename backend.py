...
def _likeness_score(text, target):
    """
    Likeness is defined as the number of characters in the selected word that coincide with the exact position of the targer
